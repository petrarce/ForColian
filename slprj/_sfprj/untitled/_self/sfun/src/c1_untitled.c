...
static const char * c1_debug_family_names[5] = { "nargin", "nargout", "z",
  "absZ", "sign" };
...
static real_T c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_sign, const char_T *c1_identifier);
  ...
  *chartInstance)
{
  ...
  real_T *c1_absZ;
  real_T *c1_sign;
  c1_sign = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_absZ = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(3), FALSE);
  c1_hoistedGlobal = *c1_absZ;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = *c1_sign;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_absZ = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "absZ");
...
static void sf_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_absZ;
  real_T *c1_b_sign;
  c1_b_sign = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_b_absZ = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_z = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_b_z, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_b_absZ, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_b_sign, 2U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 1U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_z, 2U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_absZ, 3U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_sign, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 1, c1_z > 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
    c1_sign = 1.0;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 11);
    c1_x = c1_z;
    c1_b_x = c1_x;
    c1_absZ = muDoubleScalarAbs(c1_b_x);
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 13);
  if (CV_EML_IF(0, 1, 2, c1_z > 0.0)) {
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 14);
    c1_sign = -1.0;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 15);
    c1_c_x = c1_z;
    c1_d_x = c1_c_x;
    c1_absZ = muDoubleScalarAbs(c1_d_x);
  }
...
const mxArray *sf_c1_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c1_b_info)[0].resolved =
    "[ILXE]D:/kpi/II/soft/MatLab2012b/bin/toolbox/eml/lib/matlab/elfun/abs.m";
  (*c1_b_info)[0].fileTimeLo = 1286815094U;
  ...
  (*c1_b_info)[1].fileTimeLo = 1286815112U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3343599304U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(172079287U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(428577113U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3153288914U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("XJZ747OHXnnMQDV5n7iBiB");
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"absZ\",},{M[1],M[6],T\"sign\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"absZ");
          _SFD_SET_DATA_PROPS(2,2,0,1,"sign");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,56,63,-1,91);
        _SFD_CV_INIT_EML_IF(0,1,1,93,99,-1,132);
        _SFD_CV_INIT_EML_IF(0,1,2,134,140,-1,174);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c1_absZ);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_sign);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1664817368U));
  ssSetChecksum1(S,(1167416859U));
  ssSetChecksum2(S,(574397978U));
  ssSetChecksum3(S,(1615970570U));
