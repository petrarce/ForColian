...
static const char * c1_debug_family_names[5] = { "nargin", "nargout", "dz", "dA",
  "dB" };
...
static real_T c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_dB, const char_T *c1_identifier);
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  real_T *c1_dA;
  real_T *c1_dB;
  c1_dB = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_dA = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(3), FALSE);
  c1_hoistedGlobal = *c1_dA;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = *c1_dB;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_dA = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
    "dA");
  *c1_dB = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "dB");
  chartInstance->c1_is_active_c1_untitled = c1_d_emlrt_marshallIn(chartInstance,
...
static void sf_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_dA;
  real_T *c1_b_dz;
  c1_b_dB = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_b_dA = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_dz = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_b_dz, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_b_dA, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_b_dB, 2U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_dz;
  c1_dz = c1_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 1U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_dz, 2U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_dA, 3U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_dB, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_d_x = c1_dB;
  c1_dB = c1_d_x;
  c1_dB = muDoubleScalarFloor(c1_dB);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 4);
  c1_b = c1_dB;
  c1_y = 359.0 * c1_b;
  c1_dA = (c1_dz - c1_y) - 1.0;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -4);
  ...
  const mxArray *c1_dB, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_dB), &c1_thisId);
  sf_mex_destroy(&c1_dB);
  return c1_y;
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc1_untitledInstanceStruct *)chartInstanceVoid;
  c1_dB = sf_mex_dup(c1_mxArrayInData);
...
const mxArray *sf_c1_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c1_b_info)[0].resolved =
    "[ILXE]D:/kpi/II/soft/MatLabR2012b/toolbox/eml/lib/matlab/ops/mrdivide.p";
  (*c1_b_info)[0].fileTimeLo = 1325120538U;
  (*c1_b_info)[0].fileTimeHi = 0U;
  (*c1_b_info)[0].mFileTimeLo = 1319726366U;
  ...
  (*c1_b_info)[1].resolved =
    "[ILXE]D:/kpi/II/soft/MatLabR2012b/toolbox/eml/lib/matlab/ops/rdivide.m";
  (*c1_b_info)[1].fileTimeLo = 1286815244U;
  ...
  (*c1_b_info)[2].resolved =
    "[ILXE]D:/kpi/II/soft/MatLabR2012b/toolbox/eml/lib/matlab/eml/eml_div.m";
  (*c1_b_info)[2].fileTimeLo = 1313344210U;
  (*c1_b_info)[2].fileTimeHi = 0U;
  (*c1_b_info)[2].mFileTimeLo = 0U;
  (*c1_b_info)[2].mFileTimeHi = 0U;
  (*c1_b_info)[3].context = "";
  (*c1_b_info)[3].name = "floor";
  (*c1_b_info)[3].dominantType = "double";
  (*c1_b_info)[3].resolved =
    "[ILXE]D:/kpi/II/soft/MatLabR2012b/toolbox/eml/lib/matlab/elfun/floor.m";
  (*c1_b_info)[3].fileTimeLo = 1286815142U;
  ...
  (*c1_b_info)[4].fileTimeLo = 1286815126U;
  ...
  (*c1_b_info)[5].fileTimeLo = 1289516092U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4102836034U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(516524286U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1166487590U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2631289714U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("2E6Xq0Lqj0YUHaAC0FgabB");
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dA\",},{M[1],M[6],T\"dB\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c1_dB = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c1_dA = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_dz = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_dz);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_dA);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_dB);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2067083187U));
  ssSetChecksum1(S,(1424058515U));
  ssSetChecksum2(S,(4173286659U));
  ssSetChecksum3(S,(3847199552U));
