...
static const char * c3_debug_family_names[5] = { "nargin", "nargout", "A", "B",
  "z" };
...
static real_T c3_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_z, const char_T *c3_identifier);
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = *c3_z;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_untitled;
...
static void sf_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c3_b_z;
  real_T *c3_b_B;
  c3_b_B = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_z = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_A = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_b_A, 0U);
  _SFD_DATA_RANGE_CHECK(*c3_b_z, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_b_B, 2U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_A;
  c3_b_hoistedGlobal = *c3_b_B;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c3_nargout, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c3_A, 2U, c3_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_B, 3U, c3_sf_marshallOut);
  ...
  const mxArray *c3_z, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_z), &c3_thisId);
  sf_mex_destroy(&c3_z);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc3_untitledInstanceStruct *)chartInstanceVoid;
  c3_z = sf_mex_dup(c3_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3279987208U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3807103295U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1359235118U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4079086821U);
}
...
mxArray *sf_c3_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xzQ4AxE8bpKGEBvbCbAxVE");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"z\",},{M[8],M[0],T\"is_active_c3_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c3_z;
          real_T *c3_B;
          c3_B = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c3_z = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
...
static void mdlSetWorkWidths_c3_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3829276941U));
  ssSetChecksum1(S,(3729999435U));
  ssSetChecksum2(S,(3366258090U));
  ssSetChecksum3(S,(1314027271U));
